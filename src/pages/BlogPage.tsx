...
const BLOG_PILLS = ['Company Profile', 'Web Strategy', 'Digital Branding', 'Growth Notes']
...
export function BlogPage() {
  ...
  usePageMetadata({
    title: 'Morrus Digital Connecting | Blog',
    description:
      'Baca insight Morrus Digital Connecting seputar website company profile, strategi digital, dan pengembangan brand yang lebih meyakinkan.',
  })
    ...
    return (
      <SiteLayout headerVariant="hero">
        <section className="mx-auto w-full max-w-6xl px-6 py-20">
          <p className="text-[#0b1f57]">Loading blog content...</p>
        </section>
      </SiteLayout>
    )
  }
  ...
  if (error || !data) {
    return (
      <SiteLayout headerVariant="hero">
        <section className="mx-auto w-full max-w-6xl px-6 py-20">
          <p className="text-red-600">Failed to load blog content: {error ?? 'Unknown error'}</p>
        </section>
      </SiteLayout>
    )
  }
              ...
              <div className="order-1 flex w-full flex-col items-center text-center lg:order-1 lg:col-span-7 lg:items-start lg:text-left">
                ...
                >
                  ...
                  <span className="mt-2 block text-white/94">
                    untuk bisnis yang ingin terlihat lebih meyakinkan.
                  </span>
                </h1>
                ...
                >
                  Kumpulan artikel tentang struktur website, komunikasi brand, dan strategi digital
                  yang bisa langsung dipakai untuk memperkuat kredibilitas bisnis Anda.
                </p>
