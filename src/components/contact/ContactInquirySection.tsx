      ...
      <div className="mx-auto relative z-10 w-full max-w-6xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-slate-600">
            Pilih jalur yang paling nyaman untuk Anda. Form inquiry cocok untuk penjelasan yang lebih detail, sementara WhatsApp ideal untuk percakapan awal yang lebih cepat.
          </p>
        </div>
